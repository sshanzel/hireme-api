...
export const apiServiceAccount = new gcp.serviceaccount.Account('core-api-sa', {
  accountId: 'core-api',
...
export const workerServiceAccount = new gcp.serviceaccount.Account('core-worker-sa', {
...
export const pubsubInvokerServiceAccount = new gcp.serviceaccount.Account('pubsub-invoker-sa', {
...
new gcp.projects.IAMMember('api-pubsub-publisher', {
  project: projectId,
  role: 'roles/pubsub.publisher',
  member: pulumi.interpolate`serviceAccount:${apiServiceAccount.email}`,
});

new gcp.projects.IAMMember('api-storage-admin', {
  project: projectId,
...
new gcp.projects.IAMMember('worker-pubsub-subscriber', {
  project: projectId,
  role: 'roles/pubsub.subscriber',
  member: pulumi.interpolate`serviceAccount:${workerServiceAccount.email}`,
});

new gcp.projects.IAMMember('worker-storage-viewer', {
  project: projectId,
...
new gcp.projects.IAMMember('pubsub-invoker-token-creator', {
  project: projectId,
